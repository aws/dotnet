...
**Note:** This SDK entered maintenance mode on February 25, 2026 and will only receive critical bug fixes and security updates. Consider migrating to [AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) as the recommended replacement.  
...
[![nuget](https://img.shields.io/nuget/v/Amazon.Lambda.TestTool.svg) ![downloads](https://img.shields.io/nuget/dt/Amazon.Lambda.TestTool.svg)](https://www.nuget.org/packages/Amazon.Lambda.TestTool/)  
...
[AWS SDK for .NET API Reference](https://docs.aws.amazon.com/sdk-for-net/v4/developer-guide/sdk-api-ref.html)  
